...
<Quiz
  question="Qual é o papel do OWASP Top 10 para um desenvolvedor?"
  options={[
    {
      text: "Uma lista exaustiva de todas as vulnerabilidades possíveis",
      correct: false,
      explanation: "Não é uma lista completa. É um documento de conscientização sobre os riscos mais críticos para aplicações Web.",
    },
    {
      text: "Uma referência de conscientização que ajuda a levantar perguntas sobre riscos comuns em aplicações",
      correct: true,
    },
    {
      text: "Um framework obrigatório que toda aplicação precisa estar 100% conforme",
      correct: false,
      explanation: "Não existe 'conformidade OWASP'. O Top 10 é ponto de partida, não checklist de aprovação.",
    },
  ]}
/>

<Checkpoint
  challenge="Escolha duas categorias do OWASP Top 10:2025 e descreva como cada uma poderia aparecer no código que você escreve no dia a dia."
